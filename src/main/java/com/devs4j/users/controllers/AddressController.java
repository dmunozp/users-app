...
public class AddressController {
	...
	@GetMapping
	public ResponseEntity<List<Address>> findAddressByProfileAndUser(@PathVariable("userId") Integer userId,
			@PathVariable("profileId") Integer profileId) {
		return new ResponseEntity<List<Address>>(service.findAddressByProfileAndUser(userId, profileId), HttpStatus.OK);
	}
